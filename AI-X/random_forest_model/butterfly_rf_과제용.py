...
if __name__ == "__main__":
    ...
    joblib.dump(model, os.path.join('/Users/hyun/Study/CourseWork/Coursework/AI-X/random_forest_model', 'random_forest_model_2.pkl'))
    print (f"모델이 'random_forest_model_2.pkl'에 저장되었습니다.")
